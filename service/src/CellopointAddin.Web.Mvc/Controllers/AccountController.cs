...
using CellopointAddin.Web.Models.Account;
using CellopointAddin.Web.Views.Shared.Components.TenantChange;

namespace CellopointAddin.Web.Controllers
{
    public class AccountController : CellopointAddinControllerBase
    {
